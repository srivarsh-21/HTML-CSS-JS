...
//Array of 30 words
const wordsArray = ['address', 'tense', 'airplane', 'fruit', 'reward', 'limited', 'ironic', 'response', 'whom', 'grammar', 'colonel', 'interested', 'enormity', 'tenant', 'biased', 'embarrass', 'food', 'excellent', 'height', 'poor', 'bad', 'knowledge', 'edible', 'party', 'system', 'switch', 'computer', 'querty', 'window', 'castle'];
